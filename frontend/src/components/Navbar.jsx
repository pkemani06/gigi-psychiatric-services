...
const navStyles = `
  ...
  .nav-pill-white {
    ...
    gap: 6px;
    padding: 6px 16px;
    background: rgba(249,247,243,0.15);
  ...
  .nav-pill-white:hover {
    background: rgba(249,247,243,0.28);
    border-color: rgba(249,247,243,0.55);
  ...
  .nav-book-btn:hover {
    ...
    box-shadow: 0 8px 24px rgba(92,126,106,0.35);
  }
  ...
  .nav-mobile-drawer {
    animation: drawerDown 0.28s cubic-bezier(0.16,1,0.3,1) both;
  }
    ...
    <>
      ...
      <div className="nav-announcement" style={{
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button className="nav-pill-white" onClick={() => go('/contact')}>
            Patient Form
          </button>
          <button className="nav-pill-solid" onClick={() => go('/booking')}>
            Book Appointment
          </button>
        </div>
      </div>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 32px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 76 }}>
            ...
            {/* Desktop CTA */}
            <div style={{ display: 'none', alignItems: 'center', gap: 16 }} className="desktop-cta">
            ...
            <div className="nav-mobile-drawer" style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10, padding: '0 4px' }}>
                <a href="tel:301-886-5868" style={{
                  display: 'flex', alignItems: 'center', gap: 10,
                  fontFamily: "'Figtree', sans-serif",
                  fontSize: 14, fontWeight: 500, color: '#8a7060',
